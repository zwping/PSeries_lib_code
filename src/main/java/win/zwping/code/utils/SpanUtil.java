...
public final class SpanUtil implements IUtil.INativeUtil {
    ...
    public SpanUtil setClickSpan(@NonNull final ClickableSpan1 clickSpan) {
        setClickSpan(0, false, clickSpan);
        return this;
    }
     ...
     * @return the single {@link SpanUtil} instance
     */
    public SpanUtil setClickSpan(final int clickSpanColor, final boolean clickSpanUnLine, @NonNull final ClickableSpan1 clickSpan) {
        ...
        this.clickSpan = new ClickableSpan() {
            ...
            public void updateDrawState(@NonNull TextPaint ds) {
                if (0 != clickSpanColor) {
                    ds.setColor(clickSpanColor);
                    ds.setUnderlineText(clickSpanUnLine);
    ...
    /*** 舔一下kt & lambda ***/
    public interface ClickableSpan1 {
    ...
    static class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    InputStream is =
                            Util.getApp().getContentResolver().openInputStream(mContentUri);
