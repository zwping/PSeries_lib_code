 ...
 */
public final class SDCardUtil implements IUtil.INativeUtil {
    ...
    public static List<SDCardInfo> getSDCardInfo() {
        ...
        StorageManager sm = (StorageManager) Util.getApp().getSystemService(Context.STORAGE_SERVICE);
    ...
    public static long getTotalSize() {
        String path = getSDCardPathByEnvironment();
        if (isNotEmpty(path)) {
